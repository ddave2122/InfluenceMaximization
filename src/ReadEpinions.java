...
public class ReadEpinions {

    int numOfNodes = 75888;
    //orignal dataset says there is totally 75879 nodes, however, in fact, there is 75888 nodes.
    //Orginal data set counts wrong.
	...
	public void run(){ 
	    try  
	    {  
	        FileInputStream fstream = new FileInputStream("data/soc-Epinions1.txt");  
...
//	        	System.out.println(values[0] +  " " + values[1]);
	        	...
	        	if(values[0]==75879&&values[1]==508837){
	        		//create the list
...
//        		previous1 = values[1];
	...
	public static void main(String args[]){
		...
		ArrayList<Node> list = readEpinionsData.getNodeList();
		for(Node n: list){
