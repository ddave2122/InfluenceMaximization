...
public class ReadDblp {
	...
	public void run(){ 
	    try  
	    {  
	        FileInputStream fstream = new FileInputStream("data/dblp.txt");  
...
//	        	System.out.println(values[0] +  " " + values[1]);
	        	...
	        	if(values[0]==654628&&values[1]==1990259){
	        		//create the list
...
//        		previous1 = values[1];
	...
	public static void main(String args[]){
		...
		readDblpData.run();
		ArrayList<Node> list = readDblpData.getNodeList();
		for(Node n: list){
