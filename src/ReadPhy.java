...
public class ReadPhy {

    int numOfNodes = 37154;
	...
	public void run(){ 
	    try  
	    {  
	        FileInputStream fstream = new FileInputStream("data/phy.txt");  
...
//	        	System.out.println(values[0] +  " " + values[1]);
	        	...
	        	if(values[0]==37154&&values[1]==231584){
	        		//create the list
...
//        		previous1 = values[1];
	...
	public static void main(String args[]){
		...
		readPhyData.run();
		ArrayList<Node> list = readPhyData.getNodeList();
		for(Node n: list){
